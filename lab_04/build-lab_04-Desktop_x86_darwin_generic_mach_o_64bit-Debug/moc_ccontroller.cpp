...
struct qt_meta_stringdata_CController_t {
    QByteArrayData data[9];
    char stringdata0[98];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CController_t qt_meta_stringdata_CController = {
    {
QT_MOC_LITERAL(0, 0, 11), // "CController"
QT_MOC_LITERAL(1, 12, 10), // "SendTarget"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "floor"
QT_MOC_LITERAL(4, 30, 22), // "slotChangeCurrentFloor"
QT_MOC_LITERAL(5, 53, 9), // "Direction"
QT_MOC_LITERAL(6, 63, 1), // "d"
QT_MOC_LITERAL(7, 65, 16), // "slotAchieveFloor"
QT_MOC_LITERAL(8, 82, 15) // "slotAddNewFloor"

    },
    "CController\0SendTarget\0\0floor\0"
...
void CController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CController::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CController::SendTarget)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CController::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CController.data,
    qt_meta_data_CController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CController.stringdata0))
...
// SIGNAL 0
void CController::SendTarget(int _t1)
{
