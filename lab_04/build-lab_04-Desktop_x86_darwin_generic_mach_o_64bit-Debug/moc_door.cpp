...
QT_MOC_LITERAL(1, 5, 12), // "DoorIsClosed"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "OpenDoor"
QT_MOC_LITERAL(4, 28, 8), // "slotOpen"
QT_MOC_LITERAL(5, 37, 9), // "slotClose"
QT_MOC_LITERAL(6, 47, 11), // "slotOpening"
QT_MOC_LITERAL(7, 59, 11) // "slotClosing"

    },
    "Door\0DoorIsClosed\0\0OpenDoor\0slotOpen\0"
...
void Door::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Door::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Door::DoorIsClosed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Door::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Door::OpenDoor)) {
                *result = 1;
                return;
            }
        }
